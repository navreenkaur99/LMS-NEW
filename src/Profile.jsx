  ...
  return (
    ...
    <div style={{position:"relative",zIndex:"1"}}>
      ...
      alt="User Thumbnail" className="userthumb" />
        <span style={{fontSize:"14px",marginRight:"20px"}}>Navreenkaur99@gmail.com</span>
      </div>
                <button className={style.dropdown}  style={{backgroundColor:"#294573"}} onClick={() => setIsOpen((prev) => !prev)}>
