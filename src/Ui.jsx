...
import FavoritePage from "./FavoritePage"; // Import FavoritePage component
  ...
  return (
    <>
      <div style={{backgroundColor:"#edfafa"}}>
       ...
       <FavoritePage courses={courses} favorites={favorites} /> Pass courses and favorites to FavoritePage component 
        </>
  );
}
