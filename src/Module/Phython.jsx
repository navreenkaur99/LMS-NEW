...
import style from '../CSS/Ui.module.css';
 import Phythonquiz from "./Phythonquiz"
...
<Card.Body>
          ...
          <Col md={9} id="content">
            <Row>       
              <Col>   
              <h4 style={{marginTop:"40px", color:"#294573"}}>PHYTHON CONTENT</h4></Col>
         <Col>
            ...
            <div>
              {activeModule === "chapter1" && (
                <div style={{ width: '100%',height:"170%" ,marginTop:"0px"}} >
                  <iframe
                    ...
                    width="100%"
                    height="300vh"
                    src="https://www.youtube.com/embed/vLqTf2b6GZw?si=KysPMNLiT-wpTvbi"
                    frameBorder="0"
              ...
              {activeModule === "tags" && (
                <div style={{ width: '100%', height: '400px' }}>
                  <iframe
                    title="PDF Viewer"
                   src="https://www.bu.edu/lernet/artemis/years/2011/slides/python.pdf"
                    width="100%"
                    height="300vh"
                  ></iframe>
                  {activeModule === "tags" && !isRead.tags && (
              ...
              {activeModule === "quiz" && (
                <Phythonquiz markAsRead={() => handleMarkAsRead("quiz")} />
              )}
              ...
              {activeModule === "chapter2" && (
                 <iframe
                 title="PDF Viewer"
                 src="https://static.realpython.com/python_cheat_sheet_v1.pdf"

                //  src="https://cs2113f18.github.io/java/JavaCheatSheet.pdf"
                 width="100%"
                 height="300vh"
               ></iframe>
              )}
