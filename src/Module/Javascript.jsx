...
<Card.Body>
          ...
          <Col md={9} id="content">
            <Row>       
              <Col>   
              <h4 style={{marginTop:"40px", color:"#294573"}}>JAVASCRIPT CONTENT</h4></Col>
         <Col>
            ...
            <div>
              ...
              {activeModule === "quiz" && (
                <Javascriptquiz markAsRead={() => handleMarkAsRead("quiz")} />
              )}
              ...
              {activeModule === "chapter2" && (
                 <iframe
                 title="PDF Viewer"
                 src="https://duenaslerin.com/iaw/pdfs/javascript-cheat-sheet-v1.pdf"
                 width="100%"
                 height="300vh"
               ></iframe>
              )}
