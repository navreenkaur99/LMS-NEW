...
//     // Submit quiz results to backend
//     try {
//       const answers = questions.map((_, index) => selectedOption);
//        const scores = calculateScore()
//        axios.post('http://localhost:4000/submit', { answers , scores });
//       setShowScore(true);
//       setSubmitted(true);
//       console.log(scores)
//       markAsRead();
...
//     // Submit quiz results to backend
//     try {
//       const answers = questions.map((_, index) => selectedOption[index]);
