...
<Card.Body>
          ...
          <Col md={9} id="content">
            <Row>       
              <Col>   
              <h4 style={{marginTop:"40px", color:"#294573"}}>JAVA CONTENT</h4></Col>
         <Col>
            ...
            <div>
              {activeModule === "chapter1" && (
                <div style={{ width: '100%',height:"170%" ,marginTop:"0px"}} >
                  <iframe
                    ...
                    width="100%"
                    height="300vh"
                    src="https://www.youtube.com/embed/UmnCZ7-9yDY?si=ofAaHJi6B7n4Nuvm"
                    frameBorder="0"
              ...
              {activeModule === "tags" && (
                <div style={{ width: '100%', height: '400px' }}>
                  <iframe
                    title="PDF Viewer"
                    src="https://staff.um.edu.mt/__data/assets/pdf_file/0010/57169/jn.pdf"
                    width="100%"
                    height="300vh"
                  ></iframe>
                  {activeModule === "tags" && !isRead.tags && (
              ...
              {activeModule === "quiz" && (
                <Javaquiz markAsRead={() => handleMarkAsRead("quiz")} />
              )}
